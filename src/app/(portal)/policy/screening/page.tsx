            ...
            <>
              ...
              <div className="bg-neutral-50 border border-line-light rounded-lg p-4">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="flex items-center gap-1 text-tag text-brand bg-neutral-50 px-1.5 py-0.5 rounded border border-line-light">
                ...
                {result.matches.map((m, i) => {
                  ...
                  return (
                    <div key={m.enterprise_id} className={cn(
                      ...
                      isAccepted ? "border-success bg-neutral-50" :
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
                        <div className="flex items-center gap-3">
                          <div className={cn(
                            ...
                            i === 0 ? "bg-brand text-white" : "bg-neutral-50 text-text-muted"
                          )}>
                            {i + 1}
                          </div>
                          <div>
                      ...
                      <div className="flex items-center justify-between pt-3 border-t border-line-light">
                        ...
                        <div className="flex items-center gap-2">
                          {!isAccepted && !isIgnored && (
                            <>
                              <button
                                className="flex items-center gap-1 text-xs font-medium text-success bg-neutral-50 hover:opacity-90 px-3 py-1.5 rounded border border-line-light transition-colors"
                          ...
                          {isAccepted && (
                            <div className="flex items-center gap-2">
                              <button
                                className="flex items-center gap-1 text-xs font-medium text-brand bg-neutral-50 hover:bg-surface-hover-btn px-3 py-1.5 rounded border border-line transition-colors"
