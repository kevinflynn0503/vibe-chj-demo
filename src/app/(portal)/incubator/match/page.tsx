...
import {
  ChevronLeft, Award, MapPin, Zap, Lightbulb, ChevronRight, Filter, SortAsc,
...
export default function MatchPage() {
  ...
  const resultResolved = result ?? { id: '', query_text: '', query_type: 'demand_to_incubator' as const, matches: [], sub_tasks: [], created_at: '' };
        ...
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <div className="bg-surface-card border border-line rounded-lg p-5">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button
                variant="primary"
                className="shrink-0 py-2.5 px-4"
          ...
          {showResult && (
            <>
              ...
              <div className="bg-neutral-50 border border-line-light rounded-lg p-4">
                ...
                {resultResolved.sub_tasks && (
                  <div className="flex flex-wrap gap-2 mt-3">
                    {resultResolved.sub_tasks.map(t => (
              ...
              <div className="space-y-6">
                ...
                {resultResolved.matches.map((m, i) => {
              ...
              {/* 组合建议 */}
              {resultResolved.combination_suggestion && (
