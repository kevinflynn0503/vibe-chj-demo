...
export const mockAssessments: PolicyAssessment[] = [
  ...
  { id: 'assess-005', enterprise_id: 'ent-002', enterprise_name: '上海蔚来汽车科技有限公司', policy_type: '高新技术企业', screening_result: 'pass', screening_details: [ { rule_name: '成立时间', rule_type: 'hard', result: 'pass', enterprise_value: '2014年成立', required_value: '≥1年', data_source: '企业数据库', confidence: 'high' }, { rule_name: '知识产权', rule_type: 'hard', result: 'pass', enterprise_value: '200+项专利', required_value: '≥1项一类', data_source: '企查查', confidence: 'high' }, { rule_name: '技术领域', rule_type: 'hard', result: 'pass', enterprise_value: '新能源汽车-智能驾驶', required_value: '8大领域之一', data_source: '企业数据库', confidence: 'high' }, { rule_name: '研发费用占比', rule_type: 'hard', result: 'pass', enterprise_value: '约12%', required_value: '>2亿→≥3%', data_source: '走访记录', confidence: 'medium' }, { rule_name: '高新收入占比', rule_type: 'hard', result: 'pending', enterprise_value: '未获取', required_value: '≥60%', data_source: '', confidence: 'low' }, { rule_name: '科技人员占比', rule_type: 'hard', result: 'pending', enterprise_value: '未获取', required_value: '≥10%', data_source: '', confidence: 'low' } ], grade: 'A', grade_score: 79, touch_status: 'assigned', assigned_to: '薛坤', final_result: 'pending', created_at: '2026-02-06T10:00:00Z', updated_at: '2026-02-08T10:00:00Z' },
  { id: 'assess-006', enterprise_id: 'ent-004', enterprise_name: '上海仪电集团有限公司', policy_type: '专精特新企业', screening_result: 'pass', screening_details: [ { rule_name: '成立时间', rule_type: 'hard', result: 'pass', enterprise_value: '1990年成立', required_value: '≥1年', data_source: '企业数据库', confidence: 'high' }, { rule_name: '知识产权', rule_type: 'hard', result: 'pass', enterprise_value: '500+项专利', required_value: '≥1项一类', data_source: '企查查', confidence: 'high' }, { rule_name: '技术领域', rule_type: 'hard', result: 'pass', enterprise_value: '电子信息-系统集成', required_value: '8大领域之一', data_source: '企业数据库', confidence: 'high' }, { rule_name: '研发费用占比', rule_type: 'hard', result: 'pass', enterprise_value: '约6%', required_value: '≥3%', data_source: '走访记录', confidence: 'medium' }, { rule_name: '高新收入占比', rule_type: 'hard', result: 'pending', enterprise_value: '未获取', required_value: '≥60%', data_source: '', confidence: 'low' }, { rule_name: '科技人员占比', rule_type: 'hard', result: 'pass', enterprise_value: '约15%', required_value: '≥10%', data_source: '走访记录', confidence: 'medium' } ], grade: 'A', grade_score: 82, touch_status: 'pending', assigned_to: '薛坤', final_result: 'pending', created_at: '2026-02-06T10:00:00Z', updated_at: '2026-02-07T10:00:00Z' },
  { id: 'assess-007', enterprise_id: 'ent-005', enterprise_name: '上海芯视科技有限公司', policy_type: '专精特新企业', screening_result: 'pass', screening_details: [ { rule_name: '成立时间', rule_type: 'hard', result: 'pass', enterprise_value: '2023年成立', required_value: '≥1年', data_source: '企业数据库', confidence: 'high' }, { rule_name: '知识产权', rule_type: 'hard', result: 'pending', enterprise_value: '申请中', required_value: '≥1项一类', data_source: 'deep research', confidence: 'low' }, { rule_name: '技术领域', rule_type: 'hard', result: 'pass', enterprise_value: '集成电路-传感器', required_value: '8大领域之一', data_source: '企业数据库', confidence: 'high' }, { rule_name: '研发费用占比', rule_type: 'hard', result: 'pass', enterprise_value: '约60%', required_value: '≥5%', data_source: '走访记录', confidence: 'low' }, { rule_name: '高新收入占比', rule_type: 'hard', result: 'pending', enterprise_value: '未获取', required_value: '≥60%', data_source: '', confidence: 'low' }, { rule_name: '科技人员占比', rule_type: 'hard', result: 'pass', enterprise_value: '约80%', required_value: '≥10%', data_source: '走访记录', confidence: 'medium' } ], grade: 'B', grade_score: 65, touch_status: 'visited', assigned_to: '薛坤', final_result: 'pending', created_at: '2026-02-06T10:00:00Z', updated_at: '2026-02-09T10:00:00Z' },
];
